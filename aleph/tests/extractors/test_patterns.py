...
from aleph.logic.extractors.patterns import EMAIL_REGEX, IPV4_REGEX
from aleph.logic.extractors.patterns import IPV6_REGEX, PHONE_REGEX
from aleph.logic.extractors.patterns import IBAN_REGEX
