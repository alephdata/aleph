...
def upgrade():
    ...
    op.create_index(
        op.f("ix_processing_log_component"),
        "processing_log",
        ["component"],
        unique=False,
    )
    op.create_index(
        op.f("ix_processing_log_content_hash"),
        "processing_log",
        ["content_hash"],
        unique=False,
    )
    op.create_index(
        op.f("ix_processing_log_operation"),
        "processing_log",
        ["operation"],
        unique=False,
    )
    op.create_index(
        op.f("ix_processing_log_source_loc"),
        "processing_log",
        ["source_location"],
        unique=False,
    )
...
def downgrade():
    ...
    op.drop_index(op.f("ix_processing_log_operation"), table_name="processing_log")
    op.drop_index(op.f("ix_processing_log_content_hash"), table_name="processing_log")
    op.drop_index(op.f("ix_processing_log_component"), table_name="processing_log")
