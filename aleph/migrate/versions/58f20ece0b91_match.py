...
def upgrade():
    ...
    op.create_index(op.f('ix_match_collection_id'), 'match', ['collection_id'], unique=False)
    op.create_index(op.f('ix_match_match_collection_id'), 'match', ['match_collection_id'], unique=False)
