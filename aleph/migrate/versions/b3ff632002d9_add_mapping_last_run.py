...
def upgrade():
    op.add_column('mapping', sa.Column('last_run_err_msg', sa.Unicode(), nullable=True))  # noqa
    op.add_column('mapping', sa.Column('last_run_status', sa.Unicode(), nullable=True))  # noqa
