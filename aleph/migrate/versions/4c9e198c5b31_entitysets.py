...
def upgrade():
    op.create_table('entityset',
        ...
        sa.Column('layout', postgresql.JSONB(astext_type=sa.Text()), nullable=True),  # noqa
    ...
    op.create_index(op.f('ix_entityset_collection_id'), 'entityset',
                         ['collection_id'], unique=False)
    op.create_index(op.f('ix_entityset_role_id'), 'entityset', ['role_id'],
                    unique=False)
    op.create_index(op.f('ix_entityset_type'), 'entityset', ['type'],
                    unique=False)
    ...
    op.create_index(op.f('ix_entityset_item_collection_id'), 'entityset_item',
                    ['collection_id'], unique=False)
    op.create_index(op.f('ix_entityset_item_entity_id'), 'entityset_item',
                    ['entity_id'], unique=False)
    op.create_index(op.f('ix_entityset_item_entityset_id'), 'entityset_item',
                    ['entityset_id'], unique=False)
