...
def upgrade():
    ...
    op.drop_constraint(
        "entity_headquarters_address_id_fkey", "entity", type_="foreignkey"
    )
    op.drop_constraint("entity_postal_address_id_fkey", "entity", type_="foreignkey")
    op.drop_constraint(
        "entity_registered_address_id_fkey", "entity", type_="foreignkey"
    )
    op.drop_constraint(
        "entity_residential_address_id_fkey", "entity", type_="foreignkey"
    )
