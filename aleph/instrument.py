...
def processing_log(operation, component=None, source_location=None,
...
def processing_exception(operation, exception, component=None,
                         source_location=None, content_hash=None,
                         foreign_id=None, source_id=None, document_id=None,
                         meta=None):
    ...
    processing_log(operation, component=component,
                   source_location=source_location,
                   content_hash=content_hash, foreign_id=foreign_id,
                   source_id=source_id, document_id=document_id, meta=meta,
                   error_type=error_type, error_message=error_message,
