    ...
    return (
      <table className='document_metadata_table'>
        <tbody>
          ...
          { document.file_name && (
            <tr>
              <th className="th_class"><FormattedMessage id="document.file_name" defaultMessage="File name"/></th>
              <td className='td_class'>{document.file_name}</td>
            </tr>
          )}
          { document.file_size && (
            <tr>
              <th className="th_class"><FormattedMessage id="document.file_size" defaultMessage="File size"/></th>
          ...
          { document.parent && (
            <tr>
              ...
              <td className='td_class'><Entity.Link iconClass='icon_margin_right' entity={document.parent} icon short /></td>
            </tr>
          )}
          { document.author && (
            <tr>
          ...
          { document.generator && (
            <tr>
              <th className="th_class"><FormattedMessage id="document.generator" defaultMessage="Generator"/></th>
              <td className='td_class'>{document.generator}</td>
            </tr>
          )}
          { document.languages && document.languages.length > 0 && (
            <tr>
              <th className="th_class"><FormattedMessage id="document.languages" defaultMessage="Languages"/></th>
              <td className='td_class'><Language.List codes={document.languages} /></td>
            </tr>
          )}
          { document.countries && document.countries.length > 0 && (
            <tr>
              <th className="th_class"><FormattedMessage id="document.countries" defaultMessage="Countries"/></th>
          ...
          { document.authored_at && (
            <tr>
              <th className="th_class"><FormattedMessage id="document.authored_at" defaultMessage="Authored"/></th>
              <td className='td_class'><Date value={document.authored_at} /></td>
            </tr>
          )}
          { document.modified_at && (
            <tr>
              <th className="th_class"><FormattedMessage id="document.modified_at" defaultMessage="Modified"/></th>
              <td className='td_class'><Date value={document.modified_at} /></td>
            </tr>
          )}
          { document.retrieved_at && (
            <tr>
              <th className="th_class"><FormattedMessage id="document.retrieved_at" defaultMessage="Retrieved"/></th>
              <td className='td_class'><Date value={document.retrieved_at} /></td>
            </tr>
          )}
          { document.updated_at && (
            <tr>
              <th className="th_class"><FormattedMessage id="document.updated_at" defaultMessage="Imported"/></th>
