...
export const queryEntitySets = asyncActionCreator(
  (query) => async () => queryEndpoint(query),
  { name: 'QUERY_ENTITYSETS' }
);
export const queryEntitySetEntities = asyncActionCreator(
  (query) => async () => queryEndpoint(query),
  { name: 'QUERY_ENTITYSET_ENTITIES' }
);

export const fetchEntitySet = asyncActionCreator(
  ({ id }) =>
    async () => {
...
export const createEntitySetMutate = asyncActionCreator(createEntitySet, {
  name: 'CREATE_ENTITYSET_MUTATE',
});
export const createEntitySetNoMutate = asyncActionCreator(createEntitySet, {
  name: 'CREATE_ENTITYSET_NO_MUTATE',
});
...
export const deleteEntitySet = asyncActionCreator(
  (entitySetId) => async () => {
...
export const entitySetAddEntity = asyncActionCreator(
  ({ entity, entitySetId, sync }) =>
    async () => {
...
const updateEntitySetItem =
  ({ entityId, entitySetId, judgement }) =>
  async () => {
    const payload = { entity_id: entityId, judgement: judgement };
    const response = await endpoint.post(
      `entitysets/${entitySetId}/items`,
      payload
    );
    return { data: response.data };
  };

export const updateEntitySetItemMutate = asyncActionCreator(
  updateEntitySetItem,
  { name: 'UPDATE_ESI_MUTATE' }
);
export const updateEntitySetItemNoMutate = asyncActionCreator(
  updateEntitySetItem,
  { name: 'UPDATE_ESI_NO_MUTATE' }
);
