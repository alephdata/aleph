...
description: Aleph can do more than just keyword search. This guide explains some of the more advanced queries supported by the system, as well as how to filter and refine your results.
...
<YouTube id="https://www.youtube.com/watch?v=Oolv25lo98w" />
...
<Aside type="tip" title="Learn the basicss">
  [Executing a basic search](search/anatomy-of-a-search)
</Aside>
...
<Aside type="tip" title="Advanced search">
  [Executing Advanced Search techniques](search/advanced-search-methods)
</Aside>
...
<Aside type="tip" title="Filtering">
  [Filtering your search results](search/filtering-your-search-results)
</Aside>

Finally, learn about how to search **in more contained contexts**, like within the
contents of an individual dataset or document.

<Aside type="tip" title="Other contexts">
  [Searching within other contexts](search/searching-within-other-contexts)
</Aside>
