...
![The advanced search pop-up facilitates many different advanced search methods](</assets/Screen Shot 2021-02-11 at 10.32.31.png>)
...
![](/assets/variation_search.png)

<Callout theme="danger">
  Using this operator with too high a number (greater than 3, for example) will
  cause slow searches and may return too many false results.
</Callout>
