...
<p class="lead">This page lists the design premises that are fundamental to Aleph. They are used as guidelines when conceptualising new features. These premises are not immutable, but changing any of them would have broad implications for the scope and supported use cases of the Aleph.</p>
