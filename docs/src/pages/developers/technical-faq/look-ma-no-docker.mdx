...
<p class="lead">
  ...
  this is the distribution of choice of the Aleph docker files. This assumes
  Aleph 3.4.4.
</p>

<Callout theme="danger">
  We don't recommend using Aleph without Docker. This guide was contributed by a
  community member, and it is documented here for completeness.
</Callout>
