...
<p class="lead">This page lists the design premises that are fundamental to Aleph. They’re used as guidelines when conceptualising new features. These premises aren’t immutable, but changing any of them would have broad implications for the scope and supported use cases of the Aleph.</p>
